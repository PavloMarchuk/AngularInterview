...
Если нам надо просто вывести значение модели в поле ввода, <br>то можно ограничиться и однонаправленной привязкой **[...]** 

```html
<input name="title" [ngModel]="title" />
```
Если нам надо отслеживать изменение введенных данных, <br>то мы можем использовать двунаправленную привязку **[(...)]** 
...
<details>
    <summary>
        Директива хочет поменять css клас своего хоста
    </summary>
